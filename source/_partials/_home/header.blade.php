<section class="h-screen relative " >
    <div class="md:py-16  py-8 px-6 text-center dark:text-white container flex-auto mx-auto w-full max-w-4xl ">
        ...
        <div>
                ...
                <a href="mailto:{{ $page->contact_email }}" target="_blank" class="bg-gray-200 h-10 hover:bg-gray-300 inline-flex items-center justify-center mr-2 no-underline rounded-full w-10">
